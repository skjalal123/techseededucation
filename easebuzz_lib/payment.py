...
def _typeValidation(params, salt, env):
    ...
    if not (isinstance(params['key'], basestring)):
    ...
    if not (isinstance(params['productinfo'], basestring)):
        type_value = "Product Information should be string"

    if not (isinstance(params['firstname'], basestring)):
        type_value = "First Name should be string"

    if not (isinstance(params['phone'], basestring)):
        type_value = "Phone Number should be number"

    if not (isinstance(params['email'], basestring)):
        type_value = "Email should be string"

    if not (isinstance(params['surl'], basestring)):
        type_value = "Success URL should be string"

    if not (isinstance(params['furl'], basestring)):
